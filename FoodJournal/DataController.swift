            ...
            for itemDictionary in results {
                if itemDictionary["_id"] != nil && itemDictionary["_id"] as String == idValue {
                    ...
                    if items?.count != 0 {
                        ...
                        println("\(itemDictionaryId) was already saved")
                        return
                    }
                    else {
                        ...
                        if itemDictionary["fields"] != nil {
                            ...
                            if fieldsDictionary["usda_fields"] != nil {
                                ...
                                if (usdaFieldsDictionary["CHOLE"] != nil){
                                    let colDictionary = usdaFieldsDictionary["CHOLE"]! as NSDictionary
                                    let colValue: AnyObject = colDictionary["value"]!
                                    usdaItem.cholesterol = "\(colValue)"
                                }
                                else{
                                ...
                                if (usdaFieldsDictionary["PROCNT"] != nil){
                                    let proDictionary = usdaFieldsDictionary["PROCNT"]! as NSDictionary
                                    let proValue: AnyObject = proDictionary["value"]!
                                    usdaItem.protein = "\(proValue)"
                                }
                                else{
                                    usdaItem.protein = "0"
                                }
                                ...
                                if (usdaFieldsDictionary["VITC"] != nil){
                                    let vitcDictionary = usdaFieldsDictionary["VITC"]! as NSDictionary
                                    let vitcValue: AnyObject = vitcDictionary["value"]!
