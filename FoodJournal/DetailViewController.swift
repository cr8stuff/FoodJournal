...
class DetailViewController: UIViewController {
    ...
    func saveFoodItem(foodItem: USDAItem) {
        ...
        if HKHealthStore.isHealthDataAvailable() {
            ...
            let carbohydrate = HKQuantitySample(type: HKQuantityType.quantityTypeForIdentifier(HKQuantityTypeIdentifierDietaryCarbohydrates), quantity: carbohydrateUnit, startDate: timeFoodWasEntered, endDate: timeFoodWasEntered)
        }
